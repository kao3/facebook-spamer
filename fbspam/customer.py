...
class Customers:
    def __init__(self):
        ...
        def login(self):
            self.html = {'lsd': self.lsd, 'jazoest': self.jaz, 'li': self.li, 'm_ts': self.m_ts, 'email': self._email,
                         'pass': self._passwr, 'login': self.submit}
        ...
        def snd(self):
            ...
            self.html2 = {'fb_dtsg': self.fb1, 'jazoest': self.fb2, 'body': self.sms, 'send': self.sub,
                          self.cadow[0]: self.cadow[1]}
